...
export class HailProject implements AfterViewInit, OnDestroy {
  ...
  private readonly base = '/SOCIAL%20MEDIA/حائل/';
  readonly images = [
    'معكم رالي حائل.png',
    'مليونية الفروسية.png',
    'تصميم كاس العال.png',
    'الشيخ طلال.png',
    'رمضان مبارك.png',
    'جوائز ابار 2.png',
    'عيد الاضحى.png',
    'دعوة عامة الحفل الختامي.png',
    'تهنئة العيد - بندر.png',
    'راية التوحيد.png',
    '3.5 مشاهدة.png',
    'سيارة ابار.png',
    'صرف جوائز.png',
    'صيانة المضمار.png',
    'اقتباس الامير.png',
    'اوقات الحفل العاشر.png',
    'مسابقة تصوير.png',
  ].map(f => this.base + f.replace(/ /g, '%20'));
